...
def FrequencyAnalyzer(given_frequency, actual_frequency) -> list:
    ...
    Note:   Если шаг совпадает (в примере он 0) и нормальное статистическое распределение букв,
            то обычно сумма не доходит выше 0.2, иначе колеблется в районе 1.0
